...
<h2 id='api-interface'>3. 底层API接口</h2>
...
目前底层API开放两个基础URI：
```
SUBMIT_URL = "http://172.31.4.109:32102/v1/interface/api/infer/getRequestId?"
REPLY_URL = "http://172.31.4.109:32102/v1/interface/api/result?"
```
