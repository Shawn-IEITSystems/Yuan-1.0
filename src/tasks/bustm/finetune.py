...
from tasks.bustm.bustm_dataset import BustmDataset, BustmTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = BustmDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = BustmDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = "bustm accuracy"
        return BustmDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'bustm test data predict'
        return BustmTestDataset(name, [datapath], tokenizer, args.seq_length)
