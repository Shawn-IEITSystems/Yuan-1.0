...
from tasks.csl.csl_dataset import CslDataset, CslTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = CslDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = CslDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = 'csl accuracy'
        return CslDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'csl test data predict'
        return CslTestDataset(name, [datapath], tokenizer, args.seq_length)
