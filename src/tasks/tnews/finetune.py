...
from tasks.tnews.tnews_dataset import TnewsDataset, TnewsTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = TnewsDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = TnewsDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = 'tnews accuracy'
        return TnewsDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'tnews test data predict'
        return TnewsTestDataset(name, [datapath], tokenizer, args.seq_length)
