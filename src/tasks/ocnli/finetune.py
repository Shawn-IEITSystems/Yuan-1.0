...
from tasks.ocnli.ocnli_dataset import OcnliDataset, OcnliTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = OcnliDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = OcnliDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = 'ocnli accuracy'
        return OcnliDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'ocnli test data predict'
        return OcnliTestDataset(name, [datapath], tokenizer, args.seq_length)
