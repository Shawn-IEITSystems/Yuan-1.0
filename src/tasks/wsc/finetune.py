...
from tasks.wsc.wsc_dataset import WSCDataset, WSCTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = WSCDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = WSCDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = 'wsc accuracy'
        return WSCDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'wsc test data predict'
        return WSCTestDataset(name, [datapath], tokenizer, args.seq_length)
