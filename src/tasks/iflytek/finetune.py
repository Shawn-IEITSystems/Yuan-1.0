...
from tasks.iflytek.iflytek_dataset import IFLYTEKDataset, IFLYTEKTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = IFLYTEKDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = IFLYTEKDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = 'iflytek accuracy'
        return IFLYTEKDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'iflytek test data predict'
        return IFLYTEKTestDataset(name, [datapath], tokenizer, args.seq_length)
