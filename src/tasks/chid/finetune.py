...
from tasks.chid.chid_dataset import CHIDDataset, CHIDTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = CHIDDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = CHIDDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = 'chid accuracy'
        return CHIDDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'chid test data predict'
        return CHIDTestDataset(name, [datapath], tokenizer, args.seq_length)
