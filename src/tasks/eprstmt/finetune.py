...
from tasks.eprstmt.eprstmt_dataset import EprstmtDataset, EprstmtTestDataset
...
def train_valid_datasets_provider():
    ...
    train_dataset = EprstmtDataset('training', args.train_data,
                                tokenizer, args.seq_length)
    valid_dataset = EprstmtDataset('validation', args.valid_data,
                                tokenizer, args.seq_length)
...
def metrics_func_provider():
    ...
    def single_dataset_provider(datapath):
        name = 'eprstmt accuracy'
        return EprstmtDataset(name, [datapath], tokenizer, args.seq_length)
...
def predict_func_provider():
    ...
    tokenizer = get_tokenizer()
    def single_dataset_provider(datapath):
        name = 'eprstmt test data predict'
        return EprstmtTestDataset(name, [datapath], tokenizer, args.seq_length)
